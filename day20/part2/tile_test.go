...
func TestTile_RemoveBorder(t *testing.T) {
	// prepare a tile to remove border and one to compare it with
	tile := NewTile(123, Flipped, RotatedLeft, []string{"1234", "5678", "9ABC", "DEFG"})
	expected := NewTile(123, Flipped, RotatedLeft, []string{"67", "AB"})
